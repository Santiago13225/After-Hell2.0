...
function scr_HandleWallbuy(_cost, _ammoAdd, _baseVar, _hardcoreVar, _ultraVar, _createObj){
/*var cost        = argument0;
...
var createObj   = argument5;*/
	var cost = _cost;
	var ammoAdd = _ammoAdd;
	var baseVar = _baseVar;
	var hardcoreVar = _hardcoreVar;
	var ultraVar = _ultraVar;
	var createObj = _createObj;
