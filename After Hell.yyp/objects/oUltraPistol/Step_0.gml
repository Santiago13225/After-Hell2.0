///oUltraPistol Step Event
/*This object represents the ultra pistol.*/
//This event is responsible for handling ultra pistol object behavior.
...
if(place_meeting(x, y, oPlayer)){
    ...
    if(item_add(item) == true){
        ...
        //array_push(global.PlayerWeapons, weapon);
		array_push(global.PlayerWeapons,  global.WeaponList.upistol);
		array_push(global.PlayerMag, global.WeaponList.upistol.magSize);//full mag
