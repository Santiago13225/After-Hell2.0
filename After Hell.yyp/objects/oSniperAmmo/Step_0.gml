///oSniperAmmo Step Event
/*This object represents sniper ammo.*/
//This event is responsible for handling sniper ammo behavior.
...
//Only attract if player has a sniper variant
var _hasWeapon = array_contains(global.PlayerWeapons, global.WeaponList.sniper) ||
				array_contains(global.PlayerWeapons, global.WeaponList.hsniper) ||
				array_contains(global.PlayerWeapons, global.WeaponList.usniper);
...
if(place_meeting(x, y, oPlayer)){
    ...
    for(var i = 0; i < len; i++){
        ...
        //Check for normal, hardcore or ultra sniper
        if(w == global.WeaponList.sniper || w == global.WeaponList.hsniper || w == global.WeaponList.usniper){
            hasSniper = true;
            pos = i;
