///oRifleAmmo Step Event
/*This object represents rifle ammo.*/
//This event is responsible for handling rifle ammo behavior.
...
//Only attract if player has an AR variant
var _hasWeapon = array_contains(global.PlayerWeapons, global.WeaponList.assault) ||
				array_contains(global.PlayerWeapons, global.WeaponList.hassault) ||
				array_contains(global.PlayerWeapons, global.WeaponList.uassault);
...
if(place_meeting(x, y, oPlayer)){
    ...
    for(var i = 0; i < len; i++){
        ...
        //Check for normal, hardcore or ultra assault rifle
        if(w == global.WeaponList.assault || w == global.WeaponList.hassault || w == global.WeaponList.uassault){
            hasAssault = true;
            pos = i;
