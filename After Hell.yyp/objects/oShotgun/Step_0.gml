///oShotgun Step Event
/*This object represents the shotgun.*/
//This event is responsible for handling shotgun object behavior.
...
if(place_meeting(x, y, oPlayer)){
    ...
    if(item_add(item) == true){
		...
		if(!_playerHas){
			...
			array_push(global.PlayerMag, global.WeaponList.shotgun.magSize);//start with full mag
