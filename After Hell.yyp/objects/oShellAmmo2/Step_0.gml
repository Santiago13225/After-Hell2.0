///oShellAmmo Step Event
/*This object represents shell ammo.*/
//This event is responsible for handling shell ammo behavior.
...
//Only attract if player has a shotgun variant
var _hasWeapon = array_contains(global.PlayerWeapons, global.WeaponList.shotgun) ||
				array_contains(global.PlayerWeapons, global.WeaponList.hshotgun) ||
				array_contains(global.PlayerWeapons, global.WeaponList.ushotgun);
...
if(place_meeting(x, y, oPlayer)){
    ...
    for(var i = 0; i < len; i++){
        ...
        //Check for normal, hardcore or ultra shotgun
        if(w == global.WeaponList.shotgun || w == global.WeaponList.hshotgun || w == global.WeaponList.ushotgun){
            hasShotgun = true;
            pos = i;
