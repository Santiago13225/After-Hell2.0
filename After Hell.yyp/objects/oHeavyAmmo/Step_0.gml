...
//Only attract if player has a lmg variant
var _hasWeapon = array_contains(global.PlayerWeapons, global.WeaponList.lmg) ||
				array_contains(global.PlayerWeapons, global.WeaponList.hlmg) ||
				array_contains(global.PlayerWeapons, global.WeaponList.ulmg);
