///oUltraShotgun Step Event
/*This object represents the ultra shotgun.*/
//This event is responsible for handling ultra shotgun object behavior.
...
if(place_meeting(x, y, oPlayer)){
    ...
    if(item_add(item) == true){
        ...
        //array_push(global.PlayerWeapons, weapon);
		if(!_playerHas){
			array_push(global.PlayerWeapons,  global.WeaponList.ushotgun);
			//array_push(global.PlayerAmmo, 0);
			array_push(global.PlayerMag, global.WeaponList.ushotgun.magSize);//start with full mag
