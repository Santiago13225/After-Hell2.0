///oRocketAmmo Step Event
/*This object represents rocket ammo.*/
//This event is responsible for handling rocket ammo behavior.
...
//Only attract if player has a bazooka variant
var _hasWeapon = array_contains(global.PlayerWeapons, global.WeaponList.bazooka) ||
				array_contains(global.PlayerWeapons, global.WeaponList.hbazooka) ||
				array_contains(global.PlayerWeapons, global.WeaponList.ubazooka);
...
if(place_meeting(x, y, oPlayer)){
    ...
    for(var i = 0; i < len; i++){
        ...
        //Check for normal, hardcore or ultra bazooka
        if(w == global.WeaponList.bazooka || w == global.WeaponList.hbazooka || w == global.WeaponList.ubazooka){
            hasBazooka = true;
            pos = i;
