///oColdCellAmmo Step Event
/*This object represents cold cell ammo.*/
//This event is responsible for handling cold cell ammo behavior.
...
//Only attract if player has a raygun variant
var _hasWeapon = array_contains(global.PlayerWeapons, global.WeaponList.raygun) ||
				array_contains(global.PlayerWeapons, global.WeaponList.hraygun) ||
				array_contains(global.PlayerWeapons, global.WeaponList.uraygun);
...
if(place_meeting(x, y, oPlayer)){
    ...
    for(var i = 0; i < len; i++){
        ...
        //Check for normal, hardcore or ultra raygun
        if(w == global.WeaponList.raygun || w == global.WeaponList.hraygun || w == global.WeaponList.uraygun){
            hasRaygun = true;
            pos = i;
