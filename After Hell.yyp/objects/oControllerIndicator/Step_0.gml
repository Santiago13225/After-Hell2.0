...
if(count > prev_controller_count) {
	...
	if(instance_exists(oPlayer) && (room == rm_Tutorial_Level || room == rm_Level1 || room == rm_Mission0_2 || room == rm_Arcade_Level || room == rm_House_Level1 || room == rm_Facility_Level || room == rm_Temple_Level1 || room == rm_Overlook_Level4 || room == rm_Island_Level1 || room == rm_Casino_Level1 || room == rm_Labyrinth_Level2 || room == rm_Graveyard_Level || room == rm_Museum_Level1 || room == rm_Sewers_Level || room == rm_CityBlock_Level1 || room == rm_Yard_Level1 || room == rm_Supermarket_Level || room == rm_Subway_Station_Level || room == rm_Gas_Station_Level || room == rm_Cathedral_Level || room == rm_Void_Level || room == rm_Cloudwalk_Level2 || room == rm_Inferno_Level)) {//replace with your actual gameplay room check
